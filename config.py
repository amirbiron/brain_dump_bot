...
/archive - העברת משימות לארכיון (שלח/י מספרים מופרדים בפסיק)
...
שאלות? פשוט כתבו לי! 😊
    ...
    # הודעות ארכיון
    "archive_intro": (
        "איזה משימות להעביר לארכיון?\n"
        "שלח/י מספרים מופרדים בפסיק ✅"
    ),
    "archive_none": "אין משימות פעילות להעביר לארכיון. ✨",
    "archive_done": "✅ הועברו לארכיון: {count} משימות",
}
